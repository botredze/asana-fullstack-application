<template>
  <header class="bg-white dark:bg-dark-grey top-0 left-0 w-full flex items-center sm:pr-4">
    <div class="hidden items-center sm:flex pl-6 h-20 border-r border-r-lines-light dark:border-r-lines-dark md:h-24"
      ...
      <img class="hidden dark:block" src="../assets/icons/logo-light.png" alt="logo" style="width: 220px">
      <img class="dark:hidden" src="../assets/icons/logo-dark.png" alt="logo" style="width: 220px">
    </div>
    ...
    sm:h-20">
      ...
      <div v-if="boardsStore.boards.length" class="flex items-center gap-4 ml-auto">
        <AddButtonMobile />
        <PrimarySmall @click="addTask" class="hidden sm:block">+ Добавить задачу</PrimarySmall>
